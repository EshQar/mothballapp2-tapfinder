...
def mothball(input_str, precision=16):
    input_str = f"pre({precision}) " + input_str
...
#        check_outputs(data, data_d, input_str)
...
def check_outputs(data, data_d, input_str=""):
    x, z, vx, vz = [], [], [], []
    xd, zd, vxd, vzd = [], [], [], []
...
if __name__ == "__main__":
    string = 'pre(16) f(0.411988) s st(10) outx'
